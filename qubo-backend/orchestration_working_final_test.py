...
Test that orchestration system is working correctly without logging issues
"""
...
async def test_orchestration_working() -> dict:
    """Test orchestration system without logging issues."""
