...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        default_cardinality=int(os.getenv("DEFAULT_CARDINALITY", "15")),
        default_bits=int(os.getenv("DEFAULT_BITS", "7")),
        default_max_sector=float(os.getenv("DEFAULT_MAX_SECTOR", "0.25")),
