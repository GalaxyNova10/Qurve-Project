...
export default function GPUTelemetryPage() {
  ...
  return (
    <div className="flex flex-col gap-4 min-h-[90vh] bg-[#0B1220] text-[#E5E7EB] -m-8 p-8 font-sans">
      ...
      <div className="flex justify-between items-start border-b border-[#1F2937] pb-4">
        ...
        <div className="flex gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-white text-sm font-mono">{liveMetrics?.gpu_name || 'Telemetry unavailable'}</p>
          </div>
          <div>
      ...
      {/* Main Grid Layout */}
      <div className="grid grid-cols-[280px_1fr] gap-4 flex-1 mt-2">
        ...
        {/* Right Area (Split into 2 Columns) */}
        <div className="grid grid-cols-[1fr_400px] gap-4">
          
          {/* Center Column: 3D Energy & Regime */}
          <div className="flex flex-col gap-4">
            {/* 3D Energy Landscape */}
            <Card className="bg-[#111827] border-[#1F2937] flex-1 min-h-[400px] flex flex-col overflow-hidden relative rounded-xl shadow-lg">
            ...
            {/* Regime Probabilities & Current Regime */}
          ...
          {/* Right Column: Charts & Health */}
          <div className="flex flex-col gap-4">
            <Card className="bg-[#111827] border-[#1F2937] h-[260px] flex flex-col rounded-xl shadow-lg">
      ...
      {/* Footer / Bottom Bar */}
      <div className="mt-2 pt-3 border-t border-[#1F2937] flex justify-between items-center text-xs text-[#64748B] font-medium">
